package com.ductr.ductrmain.service;

import java.util.List;
import java.util.NoSuchElementException;
import java.util.stream.Collectors;

import com.ductr.ductrmain.dto.VideoDto;
import com.ductr.ductrmain.entity.FormatEnum;
import com.ductr.ductrmain.entity.Video;
import com.ductr.ductrmain.repository.VideoRepository;
...
public class VideoService {
  ...
  public List<VideoDto> getAll() {
    ...
    return videos.stream().map(vf -> this.modelMapper.map(vf, VideoDto.class)).collect(Collectors.toList());
  }
